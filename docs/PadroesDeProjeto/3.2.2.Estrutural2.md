...
As classes **EmailService** e **PushService** representam diferentes formas de envio de notificações. O **NotificationAdapter** atua como intermediário, convertendo as estruturas específicas de cada serviço para a interface unificada **INotification**, para a modelagem foi utilizado o PlantUML.

<div align="center">
  <img src="../assets/AdapterNotificacao.jpg" alt="Diagrama Adapter Notificações" >
</div>
